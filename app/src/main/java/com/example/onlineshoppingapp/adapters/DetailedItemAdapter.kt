...
import com.example.onlineshoppingapp.databinding.DetailedItemViewBinding
import com.example.onlineshoppingapp.databinding.ProductItemBinding
import java.text.NumberFormat
import java.util.*

class DetailedItemAdapter(private val clickHandler: ClickHandler):
    ListAdapter<Product, DetailedItemAdapter.ItemHolder>(FormulaDiffCallBack) {
    ...
    class ItemHolder(val binding: DetailedItemViewBinding): RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemHolder {
        val binding: DetailedItemViewBinding = DataBindingUtil.inflate(
            LayoutInflater.from(parent.context),
            R.layout.detailed_item_view,
            parent,
            false
        )
