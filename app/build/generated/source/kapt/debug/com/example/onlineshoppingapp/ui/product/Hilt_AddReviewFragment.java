 ...
 */
public abstract class Hilt_AddReviewFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddReviewFragment_GeneratedInjector) this.generatedComponent()).injectAddReviewFragment(UnsafeCasts.<AddReviewFragment>unsafeCast(this));
    }
  }
